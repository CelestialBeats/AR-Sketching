...
fun Activity.termOfUse() {
    try {
        startActivity(
            Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://neurogamingtermsofuse.blogspot.com/p/of-use-opening-statement-individuals-or.html")
            )
        )
    } catch (e: Exception) {
        e.printStackTrace()
...
fun Activity.privacyPolicy() {
    try {
        startActivity(
            Intent(
                Intent.ACTION_VIEW,
                Uri.parse("https://neurogamingstudio.blogspot.com/2025/12/neurogaming-privacy-policy.html")
            )
        )
    } catch (e: Exception) {
        e.printStackTrace()
