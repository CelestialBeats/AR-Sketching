...
android {
    ...
    buildTypes {
        debug {
            ...
            resValue("string", "splash_native_low", "ca-app-pub-3940256099942544/2247696110")
        ...
        release {
            ...
            resValue("string", "app_id", "ca-app-pub-6806702755182088~6837934410 ")

            resValue("string", "splash_app_open_low", "ca-app-pub-6806702755182088/7441549589")
            resValue("string", "resume_app_open_low", "ca-app-pub-6806702755182088/2080907119")

            resValue("string", "splash_banner_low", "")
            resValue("string", "splash_native_low", "ca-app-pub-6806702755182088/2898689409")

            resValue("string", "banner_overall_low", "ca-app-pub-6806702755182088/6688475779")

            resValue("string", "native_exit_low", "ca-app-pub-6806702755182088/2897769537")
            resValue("string", "processing_native_low", "ca-app-pub-6806702755182088/2897769537")
            resValue("string", "native_language_low", "ca-app-pub-6806702755182088/4156910691")
            resValue("string", "native_language_select_low", "ca-app-pub-6806702755182088/6323404459")
            resValue("string", "on_boarding_one_low", "ca-app-pub-6806702755182088/5493063152")
            resValue("string", "on_boarding_two_low", "ca-app-pub-6806702755182088/3202417095")
            resValue("string", "on_boarding_three_low", "ca-app-pub-6806702755182088/6600845863")
            resValue("string", "full_native_one_low", "")
            resValue("string", "full_native_two_low", "")

            resValue("string", "rewarded_low", "ca-app-pub-6806702755182088/9035437515")

            resValue("string", "language_inter_low", "")
            resValue("string", "all_inter_low", "")
            resValue("string", "started_inter_low", "ca-app-pub-6806702755182088/8001557440")
...
//    api("com.google.ads.mediation:vungle:7.7.1.0")
    api("com.google.ads.mediation:facebook:6.21.0.1")
    api("com.google.ads.mediation:mintegral:17.0.91.0")
    api("com.google.ads.mediation:pangle:7.9.1.1.0")
