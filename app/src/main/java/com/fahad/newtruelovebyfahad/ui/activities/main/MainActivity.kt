...
import com.fahad.newtruelovebyfahad.ui.fragments.settings.SettingsFragment
    ...
    private fun initNavigationGraph() {
        try {
            ...
            navController?.addOnDestinationChangedListener { _, destination, _ ->
                ...
                when (destination.id) {
                    R.id.homeForYouFragment,R.id.settingFragment
                        -> {
    ...
    private fun loadBannerAd(fromButton: Boolean = false) {
        kotlin.runCatching {
            runOnUiThread {
                ...
                val shouldHideBanner = currentDestinationId == R.id.homeForYouFragment || currentDestinationId == R.id.settingFragment
